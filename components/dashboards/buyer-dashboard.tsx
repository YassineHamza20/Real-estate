...
const handleSubmitVerification = async () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="border-2">
        <CardContent className="pt-6">
          <div className="flex items-start gap-6">
            ...
            {/* Stats Section */}
            <div className="flex-shrink-0 flex gap-3 mt-6">
              <div className="text-center p-4 bg-muted/50 rounded-lg border">
                <div className="flex items-center justify-center gap-1.5 mb-1">
                  <Building2 className="h-4 w-4 text-primary" />
                  <div className="text-2xl font-bold">{profile?.propertiesCount || 0}</div>
                </div>
              ...
              <div className="text-center p-4 bg-muted/50 rounded-lg border">
                <div className="flex items-center justify-center gap-1.5 mb-1">
                  ...
                  <div className="text-2xl font-bold">{profile?.wishlistCount || 0}</div>
                </div>
      ...
      {/* Verification Card - Only show for buyers who want to become sellers */}
      {user?.role === "buyer" && (
        <Card className="border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-transparent mt-6">
          <CardContent className="pt-6">
...
{verificationStatus === "rejected" && (
  <Alert className="border-gray-700 bg-gray-900 mt-6">
    ...
    <AlertDescription className="space-y-1">
      ...
      {/* Saved Properties Card - Horizontal Grid */}
      <Card className="border-2 mt-6">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl">Saved Properties</CardTitle>
              <p className="text-muted-foreground mt-1">Properties you've marked as favorites</p>
            </div>
        ...
        <CardContent>
          {savedProperties.length === 0 ? (
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">{/* Property cards would go here */}</div>
          )}
        </CardContent>
      </Card>
