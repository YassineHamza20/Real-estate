    ...
    const confirmEmail = async () => {
      try {
        ...
        setTimeout(() => {
          if (!mounted) return
          setStatus('success')
          setMessage('Your email has been successfully verified! Welcome to WohnTräume.')
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-bold">WohnTräume</h1>
            ...
            <CardHeader className="text-center space-y-6 pb-8">
              ...
              <div className="space-y-3">
                ...
                <CardDescription className="text-lg">
                  {status === 'loading' && 'Securing your WohnTräume Pro account...'}
        ...
        >
          <p className="text-sm text-muted-foreground">
            Need help? <a href="mailto:yhamza@pekerholding.com" className="text-primary hover:underline">Contact Support</a>
          </p>
          <p className="text-xs text-muted-foreground">
            © 2024 WohnTräume. All rights reserved.
          </p>
        </motion.div>
      </div>
    </div>
